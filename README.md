About python-fasthtml-feedstock
===============================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/python-fasthtml-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/python-fasthtml-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add python-fasthtml
# for installing globally
pixi global install python-fasthtml
```
...
It is possible to list all of the versions of `python-fasthtml` available on your platform:
...
```
pixi search python-fasthtml --channel conda-forge
```
